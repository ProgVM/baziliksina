...
# Standard Telegram HTML formatting tags that should not be intercepted as action tags
...
class AIResponseExecutor:
    ...
    async def parse_execute_and_strip_tags(self, text: str, chat_entity, reply_to_id: int, chat_id: str) -> str:
        ...
        executes contained sub-actions asynchronously, and strips tags from the resulting text.
        """
        if not text:
            return text
