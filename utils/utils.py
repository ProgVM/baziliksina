...
def markdown_to_telegram_html(text: str) -> str:
    ...
    text = re.sub(r'<(pre|code|blockquote|tg-spoiler|tg-emoji|emoji|a|details|summary)\b[^>]*>.*?</\1>', _save_block, text, flags=re.DOTALL | re.IGNORECASE)
...
def safe_telegram_html(text: str) -> str:
    ...
    # Tag regex supporting hyphens in tag names (e.g. tg-emoji, tg-spoiler)
